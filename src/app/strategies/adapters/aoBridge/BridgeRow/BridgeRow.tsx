...
// import { AoBridgeStrategy } from "../aoBridgeAdapter";
...
// export const AoBridgeRow: React.FC<AoBridgeRowProps> = ({
//   bridgeArb,
//   prices,
// }) => {
//   const borrowTokenStats = useProtocolStats(
//     bridgeArb.borrowToken.ticker.toUpperCase(),
//   );

//   const leverageTokenStats = useProtocolStats(
//     bridgeArb.leverageToken.ticker.toUpperCase(),
//   );

//   const geckoId = tickerToGeckoMap[bridgeArb.borrowToken.ticker.toUpperCase()];
...
//           <p className={styles.fee}>{bridgeArb.type}</p>
//         </div>
...
//             <Image
//               src={`/tokens/${bridgeArb.baseToken.ticker}.svg`}
//               alt={bridgeArb.baseToken.name}
//               width={30}
//               height={30}
//             />
//           </div>
